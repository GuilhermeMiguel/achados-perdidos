...
public class PesquisaController {
	...
	public void pesquisaObjeto() {
		...
		else if(objeto.getCategoria().equals("Documento") || objeto.getCategoria().equals("RA") 
				|| objeto.getCategoria().equals("RG") || objeto.getCategoria().equals("CPF")) {
			String[] datas = formataDatas(objeto.getDataEncontro(), objeto.getDataAuxiliar());
			objetoList = objDAO.pesquisaObjeto(objeto.getCategoria(), datas[0], datas[1]);
		}
	}
